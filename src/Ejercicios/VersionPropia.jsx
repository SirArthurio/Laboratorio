...
export default function VersionPropia() {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 h-full">
          <div className=" p-4 justify-items-center">
            ...
            <div className="border-2   rounded-lg m-2 md:block hidden">
              <img
                src="https://i.pinimg.com/originals/82/cd/4d/82cd4d98a075c02b573d76462650a78b.gif"
                alt="aasdad"
              />
            </div>
          </div>
          ...
          >
            <section className="border-2 rounded-lg m-4 p-4 grid grid-cols-1 md:grid-cols-2 bg-[#252525]  shadow-md shadow-[#6c584c]">
              <div>
                <h2 className="text-start text-xl border-b hover:scale-105 hover:text-[#6c584c] transition-all duration-500 ease-in-out">
                  04/09/08: Spatulas
                </h2>
